  ...
  <div class="fixed top-4 right-4 z-50 space-y-2 max-w-sm">
    ...
    >
      <div
        ...
        :key="notification.id"
        class="tornado-panel p-4 border-l-4"
        ...
        <div class="flex items-start justify-between gap-3">
          <div class="flex items-start gap-3 flex-1">
            ...
            <div class="flex-1 min-w-0">
              <h4 class="text-sm font-semibold text-mixer-txt">
                {{ notification.title }}
              </h4>
              <p v-if="notification.message" class="text-sm text-mixer-muted mt-1 whitespace-pre-line">
              ...
              <div v-if="notification.actions && notification.actions.length > 0" class="flex gap-2 mt-3">
                <button
                  ...
                  :class="[
                    ...
                    action.variant === 'primary' ? 'bg-green-500 hover:bg-green-400 text-white' :
                    action.variant === 'secondary' ? 'bg-white/10 hover:bg-white/20 text-mixer-txt' :
          ...
          >
            <svg class="w-4 h-4 text-mixer-muted" fill="currentColor" viewBox="0 0 20 20">
...
function handleActionClick(action, notificationId) {
  if (action.handler) {
    action.handler()
  }
